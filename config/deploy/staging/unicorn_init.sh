...
##### SET THESE VARIABLES ########
##################################
AS_USER=photo-history-staging # name of user on server
APP_ROOT=/home/photo-history-staging/Photo-History-Staging/current # path to application current folder
