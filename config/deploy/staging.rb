...
set :application, "Photo-History-Staging" # unique name of application
set :user, "photo-history-staging" # name of user on server
...
set :github_repo_name, "PhotoHistory" # name of git hub repo
set :git_branch_name, "ajaxpairing" # name of branch to deploy
